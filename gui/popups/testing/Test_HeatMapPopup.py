...
class Test_HeatMapPopup(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.variable_keys = tuple(self.popup.variables["heat_map_settings"]
                                   .keys())
    ...
    def test_defaults(self):
        ...
        self.assertEqual(self.popup.heat_map_x_tick_weight.fields.
                         currentText(),
        ...
        self.assertEqual(self.popup.heat_map_y_label_weight.fields.
                         currentText(),
        ...
        self.assertEqual(self.popup.heat_map_tag_line_color.fields.
                         currentText(),
    ...
    def test_set_values(self):
        ...
        self.assertEqual(self.popup.heat_map_x_ticks_fn.fields.currentText(),
                         "Courier New")
        self.assertEqual(self.popup.heat_map_x_ticks_fn.fields.currentText(),
                         self.popup.variables["heat_map_settings"]
                         ["x_ticks_fn"])
        ...
        self.assertEqual(tuple(self.popup.variables["heat_map_settings"]
                               .keys()),
                         self.variable_keys)
    ...
    def test_values_not_set(self):
        ...
        self.assertEqual(self.popup.heat_map_x_ticks_fn.fields.currentText(),
                         "Courier New")
        self.assertNotEqual(self.popup.heat_map_x_ticks_fn.fields.
                            currentText(),
                            self.popup.variables["heat_map_settings"]
                            ["x_ticks_fn"])
        self.assertEqual(self.popup.heat_map_x_ticks_fs.field.value(), 12)
        ...
        self.assertNotEqual(self.popup.heat_map_y_label_fn.fields.
                            currentText(),
                            self.popup.variables["heat_map_settings"]
                            ["y_label_fn"])
        self.assertEqual(self.popup.heat_map_y_label_fs.field.value(), 16)
